...
const PediatricInfo = ({ pediatricInfo, onUpdate, canEdit }) => {
    ...
    const [milestones, setMilestones] = useState(pediatricInfo?.developmentalMilestones || []);
    ...
    if (!isEditing) {
        return (
            <div className="space-y-4">
                ...
                {milestones.length > 0 && (
                    <div className="mt-4">
                        <h4 className="font-semibold text-white mb-2">Developmental Milestones</h4>
                        <div className="space-y-2">
                            {milestones.map((milestone, idx) => (
                                <div key={idx} className="bg-white/5 rounded-lg p-3">
                                    <p className="text-sm text-white">{milestone.milestone}</p>
        ...
        <div className="space-y-4">
            ...
            <div className="border-t border-white/10 pt-4">
                <div className="flex justify-between items-center mb-3">
                    <h4 className="font-semibold text-white">Developmental Milestones</h4>
