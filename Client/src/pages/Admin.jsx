                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-2">
                                            {Object.entries(selectedUserDetails.documents.documents).map(([key, url]) => (
                                                <a key={key} href={`${import.meta.env.VITE_API_URL  }${url}`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 group">
                                ...
                                {documents.documents && Object.keys(documents.documents).length > 0 ? (
                                    <div className="space-y-3">
                                        {Object.entries(documents.documents).map(([key, url]) => (
                                            <a key={key} href={`${import.meta.env.VITE_API_URL }${url}`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300 group">
                                                <div>
